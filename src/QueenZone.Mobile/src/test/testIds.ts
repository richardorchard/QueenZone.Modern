...
export const testIds = {
  ...
  photoViewerStatus: 'photo-viewer-status',
  photoViewerMeta: 'photo-viewer-meta',
  ...
  timelineEventBack: 'timeline-event-back',
  timelineEventSeeAll: 'timeline-event-see-all',
  timelineEventSource: 'timeline-event-source',
  ...
  fanPerformanceDownloads: 'fan-performance-downloads',
  fanPerformanceDownloadsScreen: 'fan-performance-downloads-screen',
  fanPerformanceDownloadPrefix: 'fan-performance-download-',
