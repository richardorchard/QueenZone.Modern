...
export function AccountScreen({ navigation }: Props) {
  ...
  if (isSignedIn) {
    return (
      <PlaceholderScreen
        ...
        access="member"
        headerShown={false}
        description="Signed-in account hub. Profile, settings, and sign-out live here. Private messages have their own tab once you are signed in."
        actions={[
  ...
  return (
    <PlaceholderScreen
      ...
      access="public"
      headerShown={false}
      description="Signed-out account tab. Visitors can sign in or send a Help request. Member profile and settings stay behind sign-in."
      actions={[
