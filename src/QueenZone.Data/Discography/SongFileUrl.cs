...
/// served via the cdn2.queenzone.org Cloudflare Worker proxy (which can set
/// Content-Disposition headers for consistent download filenames).
/// </summary>
public static class SongFileUrl
{
    private const string PublicBaseUrl = "https://cdn2.queenzone.org/songfiles";
