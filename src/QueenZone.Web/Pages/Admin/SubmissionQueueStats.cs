    ...
    IReadOnlyList<SubmissionContributor> TopContributors)
{
    ...
    public int TotalApprovedLast30Days =>
        Photos.ApprovedLast30Days
        + NewsSuggestions.ApprovedLast30Days
        + Articles.ApprovedLast30Days
        + FanPerformances.ApprovedLast30Days;

    public int TotalRejectedLast30Days =>
        Photos.RejectedLast30Days
        + NewsSuggestions.RejectedLast30Days
        + Articles.RejectedLast30Days
        + FanPerformances.RejectedLast30Days;

    public int TotalStillPendingLast30Days =>
        Photos.StillPendingFromLast30Days
        + NewsSuggestions.StillPendingFromLast30Days
        + Articles.StillPendingFromLast30Days
        + FanPerformances.StillPendingFromLast30Days;
