...
/// <summary>
/// Shared axe-core "critical violations fail, serious violations log" rule, used by
/// <see cref="AccessibilitySmokeTests"/> and the sitemap sweep (<see cref="SitemapPublicRouteSweepTests"/>).
/// </summary>
internal static class AxeAssertions
{
    public static async Task AssertNoCriticalViolationsAsync(IPage page)
    {
