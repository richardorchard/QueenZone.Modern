...
The web app deploy workflow (`.github/workflows/deploy.yml`) publishes `QueenZone.Web` only. The news agent worker is a **separate** console app. Pick one of the paths below when you need cloud automation.
