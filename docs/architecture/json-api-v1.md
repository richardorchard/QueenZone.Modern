...
| `/api/v1/content/*` | Public, read-only archive content for the mobile app (news, biography today; discography, timeline, Freddie Tribute follow — #726). No authentication required. |
