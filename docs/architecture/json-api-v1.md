...
| `/api/v1/content/*` | Public, read-only archive content for the mobile app (news, biography, discography, timeline today; Freddie Tribute follows — #726). No authentication required. |
