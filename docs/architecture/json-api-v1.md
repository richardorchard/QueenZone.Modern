...
| `/api/v1/content/*` | Public, read-only archive content for the mobile app (news, Freddie Tribute today; biography, discography, timeline follow — #726). No authentication required. |
