...
| `/api/v1/content/*` | Public, read-only archive content for the mobile app (news, discography today; biography, timeline, Freddie Tribute follow — #726). No authentication required. |
