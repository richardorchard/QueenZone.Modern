...
| `/api/v1/content/*` | Public, read-only archive content for the mobile app (biography today; news, discography, timeline, Freddie Tribute follow — #726). No authentication required. |
