...
| `/api/v1/content/*` | Public, read-only archive content for the mobile app (news, timeline today; biography, discography, Freddie Tribute follow — #726). No authentication required. |
