...
| `URL` | `varchar(200)` | Bare audio filename (e.g. `2014417798057369.mp3`), not a path — stored in the private `songfiles` Azure Blob container and streamed by `/fan-performances/{id}/audio`. |
